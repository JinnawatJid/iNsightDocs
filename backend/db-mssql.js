...
const initDB = async () => {
    ...
    try {
        ...
        try {
            ...
            const creditRequests = selectResult.recordset || [];
            ...
            for (const row of creditRequests) {
                ...
                const addParamUpdate = (column, paramName, value) => {
                ...
                if (amountMissing && txData.amount !== undefined && txData.amount !== null && txData.amount !== '') {
                    addParamUpdate('request_amount', 'request_amount', txData.amount);
                }
                ...
                if (reasonMissing && txData.reason !== undefined && txData.reason !== null && txData.reason !== '') {
                    addParamUpdate('request_reason', 'request_reason', txData.reason);
                }
                ...
                if (creditTermMissing && txData.creditTerm !== undefined && txData.creditTerm !== null && txData.creditTerm !== '') {
                    addParamUpdate('request_credit_term', 'request_credit_term', txData.creditTerm);
                }
                ...
                if (termGsMissing && txData.termGS !== undefined && txData.termGS !== null && txData.termGS !== '') {
                    addParamUpdate('term_gs', 'term_gs', txData.termGS);
                }
                ...
                if (termAeMissing && txData.termAE !== undefined && txData.termAE !== null && txData.termAE !== '') {
                    addParamUpdate('term_ae', 'term_ae', txData.termAE);
                }
                ...
                if (termYcMissing && txData.termYC !== undefined && txData.termYC !== null && txData.termYC !== '') {
                    addParamUpdate('term_yc', 'term_yc', txData.termYC);
                }
                ...
                if (requestTypeMissing && txData.requestType !== undefined && txData.requestType !== null && txData.requestType !== '') {
                    addParamUpdate('request_type', 'request_type', txData.requestType);
                }

                if (updates.length > 0) {
                    request.input('id', row.id);
                    await request.query(`UPDATE CreditRequests SET ${updates.join(', ')} WHERE id = @id`);
                }
            }
