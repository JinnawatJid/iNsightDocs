...
| [ ] | ความสัมพันธ์ | ข้อความ | **มี** | เตือนหน้าบ้าน | `tungnam_relationship_note` (แสดงเมื่อเลือก "มี") |
...
| [ ] | **ตำบล/แขวง** | ข้อความ | **มี** | เตือนหน้าบ้าน | `store_subdistrict` (Local DB) / `District` (Customer API → `subdistrict`) |
| [ ] | **รหัสไปรษณีย์** | ตัวเลข | **มี** | เตือนหน้าบ้าน | `zipcode` |
| [ ] | **อำเภอ/เขต** | ข้อความ | **มี** | เตือนหน้าบ้าน | `district` |
| [ ] | **จังหวัด** | ข้อความ | **มี** | เตือนหน้าบ้าน | `province` |
| [ ] | **เบอร์โทรศัพท์** | ตัวเลข | **มี** | เตือนหน้าบ้าน | `phone` |
