...
const globalPeakExposure = computed(() => {
    let maxExp = 0;
    let currExp = 0;

    globalEvents.value.forEach(ev => {
...
const chartData = computed(() => {
    ...
    // 4. Add threshold line (Current Limit)
